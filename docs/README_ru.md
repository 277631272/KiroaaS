...
> **📢 Уведомление:** В следующей версии будет исправлена совместимость с Claude Code v2.1.69+, который отправляет блоки содержимого `tool_reference` внутри сообщений `tool_result` при использовании механизма отложенных инструментов ToolSearch.
